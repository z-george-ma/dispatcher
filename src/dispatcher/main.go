...
/*		
	if err := transactionLog.WriteAck("123"); err != nil {
		log.Fatal(err)
	}
	if err := transactionLog.Write(MessageRecord { 0, nil, "123"}); err != nil {
		log.Fatal(err)
	}
	...
	if err := transactionLog.Write(MessageRecord { 0, nil, "124"}); err != nil {
		log.Fatal(err)
	}
	
	if err := transactionLog.Write(MessageRecord { 0, nil, "124.5"}); err != nil {
		log.Fatal(err)
	}
	
	if err := transactionLog.Write(MessageRecord { 0, nil, "125"}); err != nil {
		log.Fatal(err)
	}
	
	if err := transactionLog.Write(MessageRecord { 0, nil, "126"}); err != nil {
		log.Fatal(err)
	}
		
	if err := transactionLog.WriteAck("125"); err != nil {
		log.Fatal(err)
	}
	
	if err := transactionLog.WriteAck("124"); err != nil {
		log.Fatal(err)
	}
			
	if err := transactionLog.Write(MessageRecord { 0, nil, "127"}); err != nil {
		log.Fatal(err)
	}
	
	if err := transactionLog.Write(MessageRecord { 0, nil, "128"}); err != nil {
		log.Fatal(err)
	}
